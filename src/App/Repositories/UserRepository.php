...
class UserRepository implements UserRepositoryInterface
{
    ...
    public function findBySchoolId(string $school_id): ?User
    {
        try {
            ...
            error_log("UserRepository::findBySchoolId error: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function getByRole(string $role): array
    {
        try {
            ...
            error_log("UserRepository::getByRole error: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function getStudentsByYearSection(int $year_level, string $section): array
    {
        try {
            ...
            error_log("UserRepository::getStudentsByYearSection error: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function existsBySchoolId(string $school_id): bool
    {
        try {
            ...
            error_log("UserRepository::existsBySchoolId error: " . $e->getMessage());
            return false;
        }
    }
