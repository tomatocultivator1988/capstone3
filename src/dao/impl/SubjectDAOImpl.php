...
class SubjectDAOImpl implements SubjectDAOInterface
{
    ...
    public function getAll(): array
    {
        try {
            ...
            error_log("SubjectDAOImpl::getAll error: " . $e->getMessage());
            return [];
        }
    }
    ...
    public function findById(int $subject_id): ?Subject
    {
        try {
            ...
            error_log("SubjectDAOImpl::findById error: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function findByCode(string $subject_code): ?Subject
    {
        try {
            ...
            error_log("SubjectDAOImpl::findByCode error: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function create(Subject $subject): ?int
    {
        try {
            ...
            error_log("SubjectDAOImpl::create error: " . $e->getMessage());
            return null;
        }
    }
    ...
    public function update(Subject $subject): bool
    {
        try {
            ...
            error_log("SubjectDAOImpl::update error: " . $e->getMessage());
            return false;
        }
    }
    ...
    public function delete(int $subject_id): bool
    {
        try {
            ...
            error_log("SubjectDAOImpl::delete error: " . $e->getMessage());
            return false;
        }
    }
    ...
    public function existsByCode(string $subject_code): bool
    {
        try {
            ...
            error_log("SubjectDAOImpl::existsByCode error: " . $e->getMessage());
            return false;
        }
    }
    ...
    {
        try {
            $stmt = $this->db->prepare("SELECT * FROM {$this->table} WHERE faculty_id = ? ORDER BY subject_name ASC");
            $stmt->execute([$faculty_id]);
            $data = $stmt->fetchAll(PDO::FETCH_ASSOC);
            
            return array_map(fn($row) => new Subject($row), $data);
        } catch (PDOException $e) {
            error_log("SubjectDAOImpl::getByFaculty error: " . $e->getMessage());
            return [];
        }
    }
}